...
/// Admin customer list — shows unique customers who have at least one
/// approved or completed rental. Approved tab is live; Declined is a stub.
...
class _CustomerListScreenState extends State<CustomerListScreen>
  ...
  Future<void> _loadCustomers() async {
    ...
    final customers = await CustomerService.getApprovedCustomers();
    if (mounted) {
      setState(() {
        _all = customers;
        _filtered = customers;
  ...
  /// The slice currently shown — respects pagination.
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            ...
            // 3-dot menu (placeholder for future actions)
            IconButton(
